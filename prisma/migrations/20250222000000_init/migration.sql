...
-- CreateIndex
CREATE UNIQUE INDEX "DigitalProduct_creator_id_slug_key" ON "DigitalProduct"("creator_id", "slug");

-- CreateIndex
CREATE UNIQUE INDEX "AffiliateProgram_creator_id_slug_key" ON "AffiliateProgram"("creator_id", "slug");
